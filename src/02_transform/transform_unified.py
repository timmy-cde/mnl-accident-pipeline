...
def process_single_file(spark, bucket_name, raw_filename, df_locations, locations_table_id, staging_locations_table_id, project_id, dataset):
    """
...
def run_daily_transform():
    ...
    df_final = process_single_file(
        spark, bucket_name, raw_filename, df_locations,
